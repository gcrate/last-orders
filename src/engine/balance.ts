...
export const DEFAULT_BALANCE = {
  ...
  // [min, max] age each portrait looks, judged from the art. Index 0 is adv_<class>_01.
  // A recruit gets a portrait whose range covers their rolled age.
  portraitAges: {
    fighter: [
      [18, 24], [48, 58], [20, 28], [38, 50], [30, 42], [18, 26], [42, 55], [18, 23], [30, 45], [20, 30],
      [35, 50], [20, 28], [50, 58], [28, 40], [18, 27], [35, 50], [18, 24], [30, 42], [48, 58], [19, 28],
    ],
    rogue: [
      [19, 28], [48, 58], [20, 28], [40, 52], [30, 42], [22, 32], [26, 38], [18, 24], [30, 45], [20, 30],
      [46, 58], [18, 26], [50, 58], [28, 40], [20, 28], [40, 52], [22, 30], [35, 48], [48, 58], [19, 27],
    ],
    cleric: [
      [18, 23], [50, 58], [18, 25], [40, 52], [44, 55], [20, 28], [28, 40], [18, 23], [32, 46], [20, 28],
      [46, 58], [18, 26], [52, 58], [28, 40], [18, 24], [50, 58], [18, 22], [36, 48], [48, 58], [18, 26],
    ],
    mage: [
      [18, 24], [50, 58], [20, 28], [34, 46], [32, 44], [18, 26], [26, 38], [18, 24], [32, 46], [22, 32],
      [50, 58], [18, 26], [52, 58], [28, 40], [18, 23], [52, 58], [18, 25], [42, 55], [50, 58], [18, 25],
    ],
  } as Record<'fighter' | 'rogue' | 'cleric' | 'mage', [number, number][]>,
